...
public sealed class PolicyAndInvocationTests
{
    ...
    public void Non_converse_model_without_adapter_has_clear_unsupported_error()
    {
        ...
        var strategy = new BedrockInvokeModelTextInvocationStrategy(null!, [], new NullRedactor(), Microsoft.Extensions.Options.Options.Create(new GatewayOptions()), NullLogger<BedrockInvokeModelTextInvocationStrategy>.Instance);
